                        ...
                        <form action="{{ route('super.store-user') }}" method="POST" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="nama" name="nama" value="{{ old('nama') }}" required pattern="[a-zA-Z\s]+"
                                    title="Nama hanya boleh berisi huruf dan spasi" placeholder="Masukkan nama lengkap">
                                @error('nama')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('no_telp') is-invalid @enderror"
                                    id="no_telp" name="no_telp" value="{{ old('no_telp') }}" required maxlength="14"
